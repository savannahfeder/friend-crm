# Friend CRM
CRM for founders, built during an 8-hour hackathon. Listens to your conversations using the Friend AI wearable, then generates CRM data & outreach emails to follow-up with potential customers. 
